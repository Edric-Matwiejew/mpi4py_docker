...
RUN apt-get update && \
    ...
    python3-pip python3-numpy python3-dev git cython3 pkg-config python3-pkgconfig python3-six &&\
    apt-get clean all
...
RUN cd /build/mpi4py-3.0.2 && python3 setup.py build && python setup.py install
